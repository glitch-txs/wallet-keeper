...
export async function getTokenWithBalance({ chain, token, userAddress }: {chain: Chain, userAddress: `0x${string}`, token?: Token }): Promise<Pick<Token, 'name' | 'symbol'> & { formattedBalance: string | undefined }>{
